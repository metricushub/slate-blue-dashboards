...
function DroppableColumn({ column, children }: DroppableColumnProps) {
  ...
  return (
    <Card 
      ref={setNodeRef}
      className={`${column.color || 'bg-card'} border-border flex flex-col h-fit min-h-0 ${
    ...
    <>
      ...
      >
        <div className="h-full flex flex-col min-h-0 bg-muted">
          ...
          <div 
            className="flex gap-4 overflow-x-auto overscroll-x-contain pb-4 flex-1 pr-6 bg-muted min-h-0 min-w-full" 
