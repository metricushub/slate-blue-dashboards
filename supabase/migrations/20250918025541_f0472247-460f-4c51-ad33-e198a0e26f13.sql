-- Inserir o restante dos dados com UUIDs corretos
...
-- Tarefas com UUIDs corretos
INSERT INTO public.tasks (id, client_id, title, description, owner, priority, status, due_date) VALUES
('11111111-1111-1111-1111-111111111112', '11111111-1111-1111-1111-111111111111', 'Revisar copy dos anúncios', 'Analisar e otimizar o copy das campanhas de Black Friday para melhorar CTR', 'Ana Silva', 'high', 'open', CURRENT_DATE + INTERVAL '2 days'),
('22222222-2222-2222-2222-222222222223', '22222222-2222-2222-2222-222222222222', 'Configurar pixels de conversão', 'Implementar tracking adequado para procedimentos odontológicos', 'Carlos Santos', 'medium', 'in_progress', CURRENT_DATE + INTERVAL '5 days'),
('33333333-3333-3333-3333-333333333334', '33333333-3333-3333-3333-333333333333', 'Testar novas audiences', 'Criar e testar 3 novas audiences para campanhas de matrícula', 'Mariana Costa', 'medium', 'open', CURRENT_DATE + INTERVAL '7 days'),
('44444444-4444-4444-4444-444444444445', '44444444-4444-4444-4444-444444444444', 'Análise de concorrência', 'Mapear estratégias dos principais concorrentes no delivery', 'Pedro Lima', 'low', 'completed', CURRENT_DATE - INTERVAL '1 day'),
('55555555-5555-5555-5555-555555555556', '55555555-5555-5555-5555-555555555555', 'Criar landing page', 'Desenvolver LP específica para curso intensivo de inglês', 'Julia Oliveira', 'high', 'open', CURRENT_DATE + INTERVAL '3 days');
...
('11111111-1111-1111-1111-111111111113', '11111111-1111-1111-1111-111111111111', 'Otimização de Audiences Lookalike', 'audience', 'Reduzir CPA em 20%', 'Audiences lookalike baseadas em compradores recentes devem ter melhor qualidade', 'in_progress', CURRENT_DATE - INTERVAL '3 days', 'medium', 'cpa', ARRAY['Black Friday 2024 - Roupas Femininas']),
('22222222-2222-2222-2222-222222222224', '22222222-2222-2222-2222-222222222222', 'Ajuste de Horários de Veiculação', 'scheduling', 'Aumentar lead quality', 'Veicular anúncios apenas em horários comerciais deve melhorar qualidade dos leads', 'planned', CURRENT_DATE + INTERVAL '1 day', 'high', 'lead_quality', ARRAY['Clareamento Dental - Promoção']),
('33333333-3333-3333-3333-333333333335', '33333333-3333-3333-3333-333333333333', 'Teste A/B de Criativos', 'creative', 'Melhorar CTR em 15%', 'Criativos com pessoas fazendo exercícios devem ter melhor performance', 'completed', CURRENT_DATE - INTERVAL '10 days', 'high', 'ctr', ARRAY['Matrícula Janeiro 2025']),
('55555555-5555-5555-5555-555555555557', '55555555-5555-5555-5555-555555555555', 'Implementação de Smart Bidding', 'bidding', 'Otimizar automaticamente lances', 'Smart Bidding deve melhorar performance geral das campanhas', 'planned', CURRENT_DATE + INTERVAL '5 days', 'medium', 'roas', ARRAY['Curso Intensivo de Inglês']);

-- Notas
INSERT INTO public.notes (id, client_id, title, content, tags, pinned) VALUES
('11111111-1111-1111-1111-111111111114', '11111111-1111-1111-1111-111111111111', 'Reunião de Briefing - Black Friday', 'Cliente solicitou foco em produtos com maior margem durante a Black Friday. Priorizar vestidos e casacos. Orçamento extra de R$ 5.000 aprovado para o período.', ARRAY['reuniao', 'briefing', 'black-friday'], true),
('22222222-2222-2222-2222-222222222225', '22222222-2222-2222-2222-222222222222', 'Insights do Google Analytics', 'Usuários que chegam via anúncios do Google têm 30% mais chance de agendar consulta que os do Meta. Considerar realocar orçamento.', ARRAY['analytics', 'insights', 'conversao'], false),
('33333333-3333-3333-3333-333333333336', '33333333-3333-3333-3333-333333333333', 'Feedback do Cliente', 'Academia reportou aumento de 40% nas matrículas vindas dos anúncios online. Cliente muito satisfeito com resultados.', ARRAY['feedback', 'resultados', 'satisfacao'], true),
('44444444-4444-4444-4444-444444444446', '44444444-4444-4444-4444-444444444444', 'Sazonalidade do Delivery', 'Pedidos aumentam 60% nos finais de semana. Ajustar estratégia de lances para sexta, sábado e domingo.', ARRAY['sazonalidade', 'delivery', 'weekend'], false);
